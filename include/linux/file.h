...
extern int general_file_read(struct m_inode *inode,struct file *filp,char *buf,int count);
extern int general_file_write(struct m_inode *inode,struct file *filp,char *buf,int count);
extern int general_file_lseek(int fd, off_t offset, int origin);
