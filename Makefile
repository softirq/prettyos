...
MMOBJS:=mm/memory.o mm/swap.o mm/pgtable.o mm/mmap.o mm/kmalloc.o mm/buddy.o

NETOBJS:=net/net.o

#NETLIB:=net/net.a

LIBOBJS:=lib/string.o lib/kliba.o lib/stringa.o lib/klibc.o lib/errno.o lib/list.o lib/math.o
